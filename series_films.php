...
<?php include 'headfile.php';?>
	...
	<title>RTIPLAY:::SERIES/FILMS</title>
...
<script>
	...
	$.getJSON("Emission/bindex/4/0/0.json", function (data) {
		...
		for (i = 0; i < data.data.length; i++) {
			...
			ch += '<div class="mosaic__bloc"><div class="mosaic__tile mosaic__tile--large"><a class="tile tile--16-9 tile--large" href="http://51.75.197.3/plesk-site-preview/rtiplay.ci/51.75.197.3//Emission/' + slugify(data.data[i].r_nom) + '/4-' + slugify(data.data[i].r_i) + '">' +
			...
			if (z > 4) {
				...
				mosaic__tile += '<div class="mosaic__tile" id="'+z+'"><a class="tile tile--16-9" href="http://51.75.197.3/plesk-site-preview/rtiplay.ci/51.75.197.3//Emission/' + slugify(data.data[i].r_nom) + '/4-' + slugify(data.data[i].r_i) + '"><div class="tile__image">' +
	...
	<footer class="fixed-footer" style="">
		<div class="text-center" style="padding:15px;">
			<div class="container">
				...
				<a href="#" onclick="ffiltreemission(1,4);"> <img class="chaine_1" src="assets/img/1.png" width="auto" height="22px" style="margin-right:30px;"></a>
				<a href="#" onclick="ffiltreemission(2,4);"> <img class="chaine_2" src="assets/img/2.png" width="auto" height="22px" style="margin-right:30px;"></a>
				<a href="#" onclick="ffiltreemission(3,4);"> <img class="chaine_3" src="assets/img/3.png" width="auto" height="22px" style="margin-right:30px;"></a>
				<a href="#" onclick="ffiltreemission(4,4);"> <img class="chaine_4" src="assets/img/4.png" width="auto" height="22px" style="margin-right:30px;"></a>
				<a href="#" onclick="ffiltreemission(5,4);"> <img class="chaine_5" src="assets/img/5.png" width="auto" height="22px" style="margin-right:30px;"></a>
...
<!-- Mirrored from 51.75.197.3/plesk-site-preview/rtiplay.ci/51.75.197.3//Emission-4 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Feb 2019 01:06:41 GMT -->
</html>
